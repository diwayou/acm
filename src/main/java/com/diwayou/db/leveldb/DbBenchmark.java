...
public class DbBenchmark {
    ...
    public DbBenchmark(Map<Flag, Object> flags)
        ...
        factory = (DBFactory) cl.loadClass(System.getProperty("leveldb.factory", "org.iq80.leveldb.impl.Iq80DBFactory"))
    ...
    private void run()
        ...
        for (String benchmark : benchmarks) {
            ...
            if (benchmark.equals("fillseq")) {
                write(new WriteOptions(), Order.SEQUENTIAL, DBState.FRESH, num, valueSize, 1);
            } else if (benchmark.equals("fillbatch")) {
                write(new WriteOptions(), Order.SEQUENTIAL, DBState.FRESH, num, valueSize, 1000);
            } else if (benchmark.equals("fillrandom")) {
                write(new WriteOptions(), Order.RANDOM, DBState.FRESH, num, valueSize, 1);
            } else if (benchmark.equals("overwrite")) {
                write(new WriteOptions(), Order.RANDOM, DBState.EXISTING, num, valueSize, 1);
            } else if (benchmark.equals("fillsync")) {
                write(new WriteOptions().sync(true), Order.RANDOM, DBState.FRESH, num / 1000, valueSize, 1);
            } else if (benchmark.equals("fill100K")) {
                write(new WriteOptions(), Order.RANDOM, DBState.FRESH, num / 1000, 100 * 1000, 1);
