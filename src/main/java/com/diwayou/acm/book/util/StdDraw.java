package com.diwayou.acm.book.util;
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static BufferedImage getImageFast(URL url) {
        try {
    ...
    public static void picture(double x, double y, BufferedImage image) {
        double xs = scaleX(x);
        double ys = scaleY(y);
    ...
    public static void picture(double x, double y, URL url) {
        BufferedImage image = getImageFast(url);
