...
public class Lc748 {
    ...
    public static void main(String[] args) {
        System.out.println(new Lc748().shortestCompletingWord("1s3 PSt", new String[]{"step", "steps", "stripe", "stepple"}));
    }
    ...
    public String shortestCompletingWord1(String licensePlate, String[] words) {
        ...
        for (String s : words) {
            ...
            int[] t = Arrays.copyOf(lp, lp.length);
