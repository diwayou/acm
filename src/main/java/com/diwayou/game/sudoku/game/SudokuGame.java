...
import com.diwayou.game.sudoku.game.command.*;
...
public class SudokuGame {
    ...
    public void saveState(Map outState) {
...
//        outState.putString("command_stack", mCommandStack.serialize());
    ...
    public void restoreState(Map inState) {
...
//        mCommandStack = CommandStack.deserialize(inState.getString("command_stack"), mCells);
    ...
    public long getTime() {
        if (mActiveFromTime != -1) {
            return mTime + System.currentTimeMillis() - mActiveFromTime;
        } else {
            return mTime;
        }
    }
    ...
    public void resume() {
        ...
        mActiveFromTime = System.currentTimeMillis();
    }
    ...
    public void pause() {
        ...
        mTime += System.currentTimeMillis() - mActiveFromTime;
        mActiveFromTime = -1;
